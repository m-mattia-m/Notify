...
const user = await OidcUserManager(useRuntimeConfig()).getUser()
                ...
                <Menu as="div" class="relative ml-3 flex-shrink-0">
                  <div>
                    <MenuButton class="relative flex rounded-full bg-indigo-600 text-sm text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
                      ...
                      <img class="h-8 w-8 rounded-full" src="/images/user-circle.png" alt="" />
                    </MenuButton>
                  </div>
        ...
        <DisclosurePanel class="lg:hidden">
          ...
          <div class="border-t border-indigo-700 pb-3 pt-4">
            <div class="flex items-center px-5">
              <div class="flex-shrink-0">
                <img class="h-10 w-10 rounded-full" src="/images/user-circle.png" alt="" />
              </div>
              <div class="ml-3">
                <div class="text-base font-medium text-white">{{ user?.profile.name }}</div>
                <div class="text-sm font-medium text-indigo-300">{{ user?.profile.email }}</div>
              </div>
